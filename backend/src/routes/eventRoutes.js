...
const {
  createEvent, getEvents, getEvent, updateEvent, deleteEvent, getCategories, requestAccess
} = require('../controllers/eventController');

router.get('/', optionalAuth, getEvents);
router.get('/categories', getCategories);
router.get('/:id', optionalAuth, getEvent);
router.post('/:id/request-access', authenticate, authorize('PHOTOGRAPHER'), requestAccess);
