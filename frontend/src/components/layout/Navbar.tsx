...
import {
  ...
  Image, Heart, Settings, Menu, X, Camera, ChevronDown, Users,
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="font-bold text-lg gradient-text hidden sm:block">EventMedia</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            {user ? (
              <>
                ...
                {canUpload && (
                  <Link href="/upload" className="btn-primary text-sm py-1.5 hidden sm:flex">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href="/register" className="btn-primary text-sm py-1.5 hidden sm:flex">Sign Up</Link>
              </div>
            )}
          ...
          {mobileOpen && (
            ...
            >
              <div className="py-3 space-y-1">
                ...
                {/* Mobile Upload — hidden for viewers */}
                {canUpload && (
                  <Link
                    href="/upload"
                    onClick={() => setMobileOpen(false)}
